...
# ── 自定义 Wrapper:去掉能耗惩罚 ──────────────────
class HeavyCtrlCostWrapper(gym.Wrapper):
    """
    ...
    def step(self, action):
        ...
        reward = reward + 4 * info["reward_ctrl"]
...
env = HeavyCtrlCostWrapper(gym.make("HalfCheetah-v5"))
...
model.save("ppo_halfcheetah_heavyctrl")
print("模型已保存为 ppo_halfcheetah_heavyctrl.zip")
